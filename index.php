...
<div class="main-body">
                    ...
                    <div class="inner">
                        <div class="content">
                            ...
                            <p class="description" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                                It is long established that a reader will be distracted by the <br /> readable
                                popular and best content.</p>
    ...
    <div class="sercice-area lekhapora-service-four edu-section-gap bg-color-white">
        <div class="container lekhapora-animated-shape">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row g-5 align-items-center">
                        ...
                        <div class="row g-5 align-items-end">
                            <div class="col-lg-5 col-md-6">
                                <div class="gallery-image mt--85">
                                    <img class="w-100" src="assets/images/about/about-04/gallery-1.jpg" alt="Gallery Images">
                            ...
                            <div class="col-lg-7 col-md-6">
                                <div class="gallery-image">
                                    <img class="w-100" src="assets/images/about/about-04/gallery-2.jpg" alt="Gallery Images">
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="inner">
                        ...
                        <p class="description mt--40" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec
                        ...
                        <div class="read-more-btn mt--60 mt_lg--30 mt_md--30 mt_sm--30" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                            <a class="edu-btn" href="about-us-1.php">Learn More <i class="icon-arrow-right-line-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="edu-course-area lekhapora-home-two-course course-three-wrapper edu-section-gap bg-color-white">
        <div class="container lekhapora-animated-shape">
                                ...
                                <div class="inner">
                                    <div class="thumbnail">
                                        ...
                                        <div class="top-position status-group left-bottom">
                                            <span class="lekhapora-status status-03">Language Learning</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <h6 class="title"><a href="course-details.php">Master Native English
                                    ...
                                    <div class="hover-content">
                                        <div class="content-top">
                                            <div class="top-status-bar">
                                                <span class="lekhapora-status status-03">Language
                                                    Learning</span>
                                            </div>
                                        ...
                                        <div class="read-more-btn">
                                            <a class="edu-btn btn-medium btn-white" href="course-details.php">Enroll Now<i class="icon-arrow-right-line-right"></i></a>
                                        </div>
                            ...
                            <div class="edu-card card-type-3 radius-small">
                                <div class="inner">
                                    <div class="thumbnail">
                                        ...
                                        <div class="top-position status-group left-bottom">
                                            <span class="lekhapora-status status-03">Marketing</span>
                                        </div>
                                    </div>
                                    <div class="content">
                                        <div class="card-top">
                                        ...
                                        <h6 class="title"><a href="course-details.php">The Basic Of Financial
                                                Analyst Online
                                                Course</a>
                                        </h6>
                                        <div class="card-bottom">
                            ...
                            <div class="edu-card card-type-3 radius-small">
                                <div class="inner">
                                    <div class="thumbnail">
                                        ...
                                        <div class="top-position status-group left-bottom">
                                            <span class="lekhapora-status status-03">Graphics Design</span>
                                        </div>
                                    </div>
                                    <div class="content">
                                        <div class="card-top">
                                        ...
                                        <h6 class="title"><a href="course-details.php">Introduction to
                                                Javascript for The
                                                Beginners</a>
                                        </h6>
                                        <div class="card-bottom">
                            ...
                            <div class="edu-card card-type-3 radius-small">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        ...
                                        <h6 class="title"><a href="course-details.php">Oracle SQL Developer :
                                                Essentials Tips and
                                                Tricks</a>
                                        </h6>
                                        <div class="card-bottom">
                            ...
                            <div class="edu-card card-type-3 radius-small">
                                <div class="inner">
                                    <div class="thumbnail">
                                        ...
                                        <div class="top-position status-group left-bottom">
                                            <span class="lekhapora-status status-03">Web Development</span>
                                        </div>
                                    </div>
                                    <div class="content">
                                        <div class="card-top">
                                        ...
                                        <h6 class="title"><a href="course-details.php">Education Makes A Person
                            ...
                            <div class="edu-card card-type-3 radius-small">
                                <div class="inner">
                                    <div class="thumbnail">
                                        ...
                                        <div class="top-position status-group left-bottom">
                                            <span class="lekhapora-status status-03">Programming</span>
                                        </div>
                                    </div>
                                    <div class="content">
                                        <div class="card-top">
                                        ...
                                        <h6 class="title"><a href="course-details.php">Python Django Web
                                                Development: To-Do
                                                App</a>
                                        </h6>
                                        <div class="card-bottom">
    ...
    <div class="lekhapora-home-two-counter edu-counterup-area counterup-wrapper-1 edu-section-gapBottom bg-color-white">
                ...
                <div class="col-lg-6">
                    <div class="newsletter-right-content d-block d-sm-flex align-items-center justify-content-start justify-content-lg-end">
                        <div class="contact-btn">
                            <a class="edu-btn btn-white" href="#">Get Started Now<i class="icon-arrow-right-line-right"></i></a>
                        </div>
