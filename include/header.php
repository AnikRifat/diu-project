...
<head>
    ...
    <link rel="stylesheet" href="assets/css/vendor/lekhapora-font.css">
                ...
                <div class="col-lg-6 d-none d-xl-block">
                    <nav class="mainmenu-nav d-none d-lg-block">
                        <ul class="mainmenu">
                            ...
                            <li class=""><a href="teachers.php">Teachers</a></li>
                    ...
                    <div class="header-right d-flex justify-content-end">
                        <div class="header-menu-bar">
                            ...
                            <div class="quote-icon quote-user d-none d-md-block ml--15 ml_sm--5">
                                <a class="edu-btn btn-medium left-icon header-button" href="login-register.php"><i class="ri-user-line"></i>Login / Register</a>
                            </div>
